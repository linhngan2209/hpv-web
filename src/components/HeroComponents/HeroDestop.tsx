...
const HeroSectionDesktop: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen bg-gradient-to-br from-[#A5DAF1] to-white dotted-bg overflow-hidden pt-24 pb-12"
    >
      <div
        className=" absolute inset-0 opacity-30"
        style={{
          backgroundImage: 'radial-gradient(circle, rgba(255, 209, 102, 0.15) 1px, transparent 1px)',
          backgroundSize: '30px 30px'
        }}
      />

      <div className="absolute top-40 left-10 w-16 h-16 bg-[#ffd166] rounded-full opacity-60 animate-float" />
      ...
      <div className="absolute bottom-32 left-32 w-20 h-20 bg-[#ffffff] rotate-45 opacity-50 animate-float-delay-2" />
      <div className="absolute top-1/2 right-10 w-12 h-12 bg-[#5196db] rounded-full opacity-50 animate-float" />
      ...
      <div className="container mx-auto px-4 sm:px-6 h-full flex flex-col items-center justify-center relative z-10 min-h-[calc(100vh-6rem)]">
        <div className="w-full max-w-5xl bg-[#2D5E4F] rounded-3xl p-8 sm:p-12 lg:p-16 mb-18 relative shadow-2xl animate-fade-in-up">

          <div className="absolute -top-4 -right-4 w-12 h-12 bg-[#ffd166] rounded-full animate-wiggle shadow-lg" />
          ...
          <div className="flex items-center justify-center gap-6 sm:gap-8 md:gap-12">
            <div className="animate-float">
              <VirusIcon className="text-[#FFD166] w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 animate-spin-slow" />
            </div>
            ...
            <div className="animate-float-delay-2">
              <HandHoldingHeartIcon className="text-[#5196db] w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" />
            </div>
          </div>
        </div>

        <button
          className="relative text-white font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-full shadow-2xl bg-gradient-to-br from-[#2D5E4F] to-[#5196db] transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 hover:from-[#5196db] hover:to-[#2D5E4F] animate-pulse-glow"
      ...
      <style jsx>{`
                ...
                @keyframes pulse-glow {
                  0%, 100% { box-shadow: 0 0 35px rgba(81, 150, 219, 0.7); }
                  50% { box-shadow: 0 0 50px rgba(81, 150, 219, 0.9); }
                }
                @keyframes fadeInUp {
